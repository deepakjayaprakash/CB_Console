  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="http://newstag.cloudbyte.com/partner-page-login/"
 style="color:white;padding:20px;padding-top:40px;">HOME</a></li>
			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form id="login-form" action="http://newstag.cloudbyte.com/partner-check-login/" method="post" role="form" style="display: block;">
								...
								<form id="register-form" action=" http://newstag.cloudbyte.com/partner-register/" method="POST" role="form" style="display: none;">
									<div class="form-group">
										<input type="text" name="username" id="username" tabindex="1" class="form-control" placeholder="Username" value="">
									</div>
                                    <div class="form-group">

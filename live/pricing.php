  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="http://newstag.cloudbyte.com/partner-dashboard/" style="color:white;padding:20px;padding-top:40px;">BACK</a></li>
...
<div class="col-md-8">
    <div class="container-fluid" style="border:1px solid; padding:30px;">
        <div class="row">
            <center><img src="http://newstag.cloudbyte.com/wp-content/themes/cloudbyte/Console/images/cloudbyteLogoQuote.PNG" </center>
                <h1>Price Quote</h1>
        </div>
        <div class="row">
            <div class="col-md-6">
